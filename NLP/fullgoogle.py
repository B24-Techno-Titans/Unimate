...
def speak(text):
    try:
        tts = gTTS(text=text, lang='en', tld='com')  # female-sounding US English
        tts.save(TTS_FILE)  # save as persistent file
        os.system(f"mpg123 -a {AUDIO_OUTPUT} {TTS_FILE}")  # play through 3.5mm jack
