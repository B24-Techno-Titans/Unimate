    ...
    def on_touch_up(self, touch):
        ...
        if self._pressed:
            ...
            if self.collide_point(*touch.pos) and self._on_toggle is not None:
                _schedule_touch_safe(self, self._on_toggle)
        return result
    ...
    def on_touch_up(self, touch):
        ...
        if self._pressed:
            ...
            if self.collide_point(*touch.pos) and self._on_delete is not None:
                _schedule_touch_safe(self, self._on_delete)
        return result
...
class UniMateKeyboard(BoxLayout):
    ...
    def __init__(self, text_input: TextInput, **kwargs):
        ...
        for row_keys in _TODO_KEYBOARD_ROWS:
...
def build_study_screen(on_voice_quiz_open: Callable[[], None] | None = None) -> Screen:
    ...
    def _open_todo_popup() -> None:
        ...
        _bind_touch_safe_on_press(close_btn, _close_todo)
